...
function Core() {
    ...
    /* Loading Modules */
    communicationManager = new (require("./lib/communicationManager"))();
    connectionManager = new (require("./lib/connectionManager"))();
    configurationManager = new (require("./lib/configurationManager"))();
    deploymentManager = new (require("./lib/deploymentManager"))();
    faultManager = new (require("./lib/faultManager"))();
    fileSystemManager = new (require("./lib/fileSystemManager"))();
    jobManager = new (require("./lib/jobManager"))();
    metricsManager = new (require("./lib/metricsManager"))();
